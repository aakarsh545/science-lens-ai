-- =====================================================
-- GENERAL CHEMISTRY - COMPLETE STRUCTURE
-- 10 chapters, 100 lessons
-- =====================================================

-- Chapter 1: Atomic Structure
--   1.1 Lesson 1.1: Introduction to Atomic Structure
...
--   2.1 Lesson 2.1: Introduction to Chemical Bonding
...
--   3.1 Lesson 3.1: Introduction to States of Matter
...
--   4.1 Lesson 4.1: Introduction to Stoichiometry
...
--   5.1 Lesson 5.1: Introduction to Types of Reactions
...
-- Chapter 6: Solutions
--   6.1 Lesson 6.1: Introduction to Solutions
...
--   7.1 Lesson 7.1: Introduction to Acids and Bases
...
--   8.1 Lesson 8.1: Introduction to Chemical Equilibrium
...
--   9.1 Lesson 9.1: Introduction to Thermochemistry
...
--   10.1 Lesson 10.1: Introduction to Electrochemistry
