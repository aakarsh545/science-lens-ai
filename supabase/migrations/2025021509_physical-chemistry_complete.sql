-- =====================================================
-- PHYSICAL CHEMISTRY - COMPLETE STRUCTURE
-- 10 chapters, 100 lessons
-- =====================================================

-- Chapter 1: Quantum Chemistry
--   1.1 Lesson 1.1: Introduction to Quantum Chemistry
...
--   2.1 Lesson 2.1: Introduction to Spectroscopy
...
--   3.1 Lesson 3.1: Introduction to Thermodynamics
...
--   4.1 Lesson 4.1: Introduction to Statistical Mechanics
...
-- Chapter 5: Kinetics
--   5.1 Lesson 5.1: Introduction to Kinetics
...
-- Chapter 6: Dynamics
--   6.1 Lesson 6.1: Introduction to Dynamics
...
--   7.1 Lesson 7.1: Introduction to Surface Chemistry
...
-- Chapter 8: Macromolecules
--   8.1 Lesson 8.1: Introduction to Macromolecules
...
--   9.1 Lesson 9.1: Introduction to Computational Chemistry
