-- =====================================================
-- GEOLOGY AND PLATE TECTONICS - COMPLETE STRUCTURE
-- 10 chapters, 100 lessons
-- =====================================================

-- Chapter 1: Earth Materials
--   1.1 Lesson 1.1: Introduction to Earth Materials
...
--   2.1 Lesson 2.1: Introduction to Geological Time
...
--   3.1 Lesson 3.1: Introduction to Plate Tectonics
...
-- Chapter 4: Earthquakes and Volcanes
--   4.1 Lesson 4.1: Introduction to Earthquakes and Volcanes
...
-- Chapter 5: Surface Processes
--   5.1 Lesson 5.1: Introduction to Surface Processes
...
-- Chapter 6: Hydrology
--   6.1 Lesson 6.1: Introduction to Hydrology
...
-- Chapter 7: Glaciation
--   7.1 Lesson 7.1: Introduction to Glaciation
...
--   8.1 Lesson 8.1: Introduction to Geological Resources
...
--   9.1 Lesson 9.1: Introduction to Planetary Geology
...
-- Chapter 10: Environmental Geology
--   10.1 Lesson 10.1: Introduction to Environmental Geology
...
-- =====================================================
-- END OF GEOLOGY AND PLATE TECTONICS
-- =====================================================