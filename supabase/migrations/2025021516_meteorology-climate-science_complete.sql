-- =====================================================
-- METEOROLOGY AND CLIMATE SCIENCE - COMPLETE STRUCTURE
-- 10 chapters, 100 lessons
-- =====================================================

-- Chapter 1: Atmospheric Composition
--   1.1 Lesson 1.1: Introduction to Atmospheric Composition
...
--   2.1 Lesson 2.1: Introduction to Weather Systems
...
--   3.1 Lesson 3.1: Introduction to Climate Zones
...
--   4.1 Lesson 4.1: Introduction to Climate Change
...
--   5.1 Lesson 5.1: Introduction to Meteorology
...
--   6.1 Lesson 6.1: Introduction to Forecasting
...
--   7.1 Lesson 7.1: Introduction to Severe Weather
...
-- Chapter 8: Climate Modeling
--   8.1 Lesson 8.1: Introduction to Climate Modeling
...
-- Chapter 9: Paleoclimatology
--   9.1 Lesson 9.1: Introduction to Paleoclimatology
...
-- Chapter 10: Applied Climate Science
--   10.1 Lesson 10.1: Introduction to Applied Climate Science
...
-- =====================================================
-- END OF METEOROLOGY AND CLIMATE SCIENCE
-- =====================================================